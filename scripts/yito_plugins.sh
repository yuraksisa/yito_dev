...
git clone https://github.com/yuraksisa/ysd_md_calendar.git
...
git clone https://github.com/yuraksisa/ysd_md_order.git
...
git clone https://github.com/yuraksisa/ysd_md_rates.git
